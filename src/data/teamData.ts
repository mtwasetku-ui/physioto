...
Her background in physiotherapy means she can speak the same language as both patients and clinicians, which makes all the difference in a small, patient-focused practice like Physio to Home.`,
  ...
  },
  {
    ...
    bio: `Jackline brings over 10 years of physiotherapy experience across hospital and rehabilitation settings in Egypt and Australia. She holds a Bachelor of Physiotherapy and a Doctor of Physical Therapy from Cairo University, and is AHPRA registered.

Jackline has worked across orthopaedic, acute, and chronic care settings, with a strong focus on manual therapy, pain management, and individually tailored exercise programs. She is known for building genuine rapport with her patients and taking the time to ensure they fully understand their condition and treatment.

Jackline speaks both English and Arabic, making her especially well placed to support patients from Arabic-speaking backgrounds.`,
  ...
  },
  {
    ...
    bio: `Kanza is an AHPRA registered Physiotherapist who completed her Doctor of Physical Therapy from LMDC, with advanced training in neurological rehabilitation and musculoskeletal physiotherapy. She works with conditions such as cerebral palsy and hemiplegia, focusing on improving mobility, function, and quality of life.

She also integrates musculoskeletal rehabilitation, post-operative rehabilitation, and women's health physiotherapy into her holistic approach to care. Kanza is trained and competent in Mobilisation and Manual Therapy, Dry Needling, and Kinesio Taping, with a research-based clinical approach.`,
...
Rafik provides home visit physiotherapy with Physio To Home, supporting patients to improve mobility, independence, and quality of life in their own environment. He is known for his clear communication, patient education, and ability to adapt treatment plans to individual goals and home environments.`,
  ...
  },
  {
    ...
    bio: `Christine enjoys helping people improve mobility, reduce pain, and build independence in everyday life. Her approach is calm, supportive, and focused on achievable long-term progress.

She has worked across musculoskeletal clinics, community rehabilitation, aged care, WorkCover programs, and NDIS services both overseas and throughout Australia, including nearly seven years in Queensland. Christine has extensive experience supporting people living with chronic pain, mobility challenges, neurological conditions, and functional limitations.

She was inspired to pursue physiotherapy after seeing firsthand how rehabilitation positively transformed the life of a close family member, and values the combination of movement, problem-solving, and genuine human connection the profession offers.`,
