...
export interface CoverflowCarouselProps {
  ...
  /** Called when a card is tapped/clicked (not fired after a drag). */
...
export function CoverflowCarousel({
  ...
  const onCardClick = (index: number) => {
    // A drag that moved shouldn't also register as a click-through.
        ...
        <div
          ...
          onKeyDown={(event) => {
            if (event.key === "ArrowLeft") {
              ...
              event.preventDefault();
              onSlideClick?.(indexAt(targetRef.current));
            }
          }}
